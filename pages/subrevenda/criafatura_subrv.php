...
//Insere fatura
$faturains = "insert into fatura_clientes (usuario_id,id_mestre,tipo,qtd,data,datavencimento,status,descrição,valor,desconto) values ('".$ssh['id_usuario']."','".$_SESSION['usuarioID']."','".$tipo."','1','".$data."','".$dataexpire."','pendente','".$desc."','".$valorssh."','".$desconto."')";
